...
![Настройка агрегирования каналов на msk-donskaya-nvsakhno-sw-1](image/25.png){#fig:025 width=70%}

## Выполнение лабораторной работы

![Настройка агрегирования каналов на msk-donskaya-nvsakhno-sw-1](image/26.png){#fig:026 width=30%}
